...
#define PRODUCT_KEY   "5ba68ba465dc4499bc32a34540f066ab"//"8bef2268616a4a2990a6761a35830797" 
...
#if( GAGENT_RELEASE==1)
  #define HTTP_SERVER          "api.gizwits.com"//"api1.iotsdk.com" //Nik.chen for test
#else
  #define HTTP_SERVER         "api.iotsdk.com"
#endif

#define GAGENT_TEST_AP1        "GIZWITS_TEST_1" //"1801_3"
#define GAGENT_TEST_AP2        "GIZWITS_TEST_2"
#define GAGENT_TEST_AP_PASS    "GIZWITS_TEST_PASS"  //"18011801"
...
#define XPG_CFG_FLAG_CONFIG_AP      (1<<6)  
...
//#define AS xpg_assert(0) ((void)0) // 显示代码位置
